...
let newAngle = false;    // trigger za nov kot poti obročev; taka komplikacija, ker si me ne da kota sporočat v obliki spremembe, kar bi že samo lahko bilo trigger;
let bump = 0;
// let changesLog = [];    // mora bit let, ker ne pušamo vanjo, amapk ji dodelimo vsakič novo vrednost;
